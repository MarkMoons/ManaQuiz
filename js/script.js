...
var DuivenBackup = Duiven.slice();
var HoendersBackup = Hoenders.slice();
var WatervogelsBackup = Watervogels.slice();
var SiervogelsBackup = Siervogels.slice();
...
function checkAntwoord()
{
    ...
    if (gebruikersAntwoord === "fortnite"){
...
function getFoto()
{
        ...
        randomGetal = Math.floor(Math.random() * (3 - 1 + 1)) + 1;
        ...
        } else if (randomDier === "Volierevogels" && Volierevogels.length !== 0) {
            var randomVolierevogels = Volierevogels[Math.floor(Math.random() * Volierevogels.length)];
            console.log(randomVolierevogels);
            document.getElementById('foto').src = './images/' + randomDier + '/' + randomVolierevogels + '/' + randomVolierevogels + randomGetal + '.jpg';
            goedAntwoord = randomVolierevogels;

        } else if (randomDier === "Duiven" && Duiven.length !== 0) {
            var randomDuiven = Duiven[Math.floor(Math.random() * Duiven.length)];
            console.log(randomDuiven);
            document.getElementById('foto').src = './images/' + randomDier + '/' + randomDuiven + '/' + randomDuiven + randomGetal + '.jpg';
            goedAntwoord = randomDuiven;

        } else if (randomDier === "Hoenders" && Hoenders.length !== 0) {
            var randomHoenders = Hoenders[Math.floor(Math.random() * Hoenders.length)];
            console.log(randomHoenders);
            document.getElementById('foto').src = './images/' + randomDier + '/' + randomHoenders + '/' + randomHoenders + randomGetal + '.jpg';
            goedAntwoord = randomHoenders;

        } else if (randomDier === "Watervogels" && Watervogels.length !== 0) {
            var randomWatervogels = Watervogels[Math.floor(Math.random() * Watervogels.length)];
            console.log(randomWatervogels);
            document.getElementById('foto').src = './images/' + randomDier + '/' + randomWatervogels + '/' + randomWatervogels + randomGetal + '.jpg';
            goedAntwoord = randomWatervogels;

        } else if (randomDier === "Siervogels" && Siervogels.length !== 0) {
            var randomSiervogels = Siervogels[Math.floor(Math.random() * Siervogels.length)];
            console.log(randomSiervogels);
            document.getElementById('foto').src = './images/' + randomDier + '/' + randomSiervogels + '/' + randomSiervogels + randomGetal + '.jpg';
            goedAntwoord = randomSiervogels;
...
function refreshFoto(){
    var rand = randomGetal;
    while (rand === randomGetal){
        rand = Math.floor(Math.random() * (3 - 1 + 1)) + 1;
    }
    randomGetal = rand;
    document.getElementById('foto').src = './images/' + randomDier + '/' + goedAntwoord + '/' + goedAntwoord + rand + '.jpg';
};
...
function selectBlok3()
{
    $(".radio").css('display') == 'block'
    $(".radio").show();
    $("#radioDierenBlok3").css('display') == 'block'
    $("#radioDierenBlok3").show();
    $(".selectBlok").css('display') == 'none'
    $(".selectBlok").hide();
    huidigBlok = 3;
};
...
function startQuiz(){
    ...
    if (Dieren.length <= 0){
        window.alert("Je moet wel iets selecteren, eikelbrein.")
    } else {
...
function goBack(){
    ...
    $("#radioDierenBlok3").css('display') == 'none'
    $("#radioDierenBlok3").hide();
    $(".radio").css('display') == 'none'
    $(".radio").hide();
    $(".selectBlok").css('display') == 'block'
    $(".selectBlok").show();
